...
- [~] **I2** Vercel Web Analytics: script tag added 2026-09-05; **user must click Enable under the project's Analytics tab** for data to start. Only the Vercel account sees the dashboard (visitors, page views per path, referrers, countries). DoD: first page views appear in the dashboard.
