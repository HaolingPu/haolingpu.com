...
- [x] **G15** **Chinese home page** `/zh/` (2026-09-05): translated bio, section labels, roles, highlights, project and research summaries, education, hobbies; EN/中文 switch in the header; CJK font stack. Chinese name 蒲浩领 added 2026-09-05. Open: sub-pages in Chinese.
